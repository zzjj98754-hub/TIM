...
public class DemoMessageController {
    ...
    @PostMapping("/groups/{groupId}/messages/{userId}/ack") public void groupAck(@PathVariable long groupId, @PathVariable long userId, @RequestParam long cursor) { groups.acknowledge(groupId, userId, cursor); }
}

...
CREATE TABLE IF NOT EXISTS group_message (message_id VARCHAR(64) PRIMARY KEY, group_id BIGINT NOT NULL, group_sequence BIGINT NOT NULL, sender_id BIGINT NOT NULL, content TEXT NOT NULL, created_at TIMESTAMP NOT NULL, UNIQUE KEY uk_group_sequence(group_id, group_sequence));
...
CREATE TABLE IF NOT EXISTS message_delivery (
  ...
  lease_owner VARCHAR(128), lease_until TIMESTAMP NULL, last_error VARCHAR(512) NULL,
